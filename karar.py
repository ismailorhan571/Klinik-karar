...
# === YENİ: RATE LIMIT VE BOŞ EKRAN KORUMASI (Sadece bu kısım eklendi) ===
...
if st.button("🚀 ANALİZİ BAŞLAT"):
    if not b:
        ...
        with c2:
            ...
            # === YENİ VE İYİLEŞTİRİLMİŞ AI BÖLÜMÜ ===
            st.info("🤖 Gemini AI Klinik Yorumu:")
            
            if st.session_state.ai_klinik_yorum is None:
                try:
                    with st.spinner("Gemini analiz ediliyor... (Kota koruması aktif)"):
                    ...
                    st.session_state.ai_klinik_yorum = f"❌ AI Hatası: {str(e)}\n\n💡 30-60 saniye bekleyip tekrar 'ANALİZİ BAŞLAT' butonuna basın."
